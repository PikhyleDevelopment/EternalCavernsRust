...
impl CellularAutomataBuilder {
    ...
    fn build(&mut self) {
        ...
        // Again, please don't forget the stairs!
        ...
        noise.set_frequency(0.08); // TODO: Play with value
        noise.set_cellular_distance_function(rltk::CellularDistanceFunction::Manhattan); // TODO: Play with value
