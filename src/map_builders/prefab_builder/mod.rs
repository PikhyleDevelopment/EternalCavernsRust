...
impl PrefabBuilder {
    ...
    pub fn new(new_depth: i32, previous_builder: Option<Box<dyn MapBuilder>>) -> PrefabBuilder {
        PrefabBuilder {
            ...
            /*mode: PrefabMode::Constant {
                level: prefab_levels::POPULATED_MAP
            },*/
    ...
    fn char_to_map(&mut self, ch: char, idx: usize) {
        ...
        match ch {
            ...
            'T' => {
                self.map.tiles[idx] = TileType::Floor;
                self.spawn_list.push((idx, "Troll".to_string()));
            }
            '^' => {
                self.map.tiles[idx] = TileType::Floor;
            ...
            for y in 0..layer.height {
                for x in 0..layer.width {
                    ...
                    if x < self.map.width as usize && y < self.map.height as usize {
                        ...
                        // We're doing some nasty casting to make it easier to type things like '#' in match
    ...
    fn apply_room_vaults(&mut self) {
        ...
        // Note that this is a place-holder and will be moved out of this function eventually
