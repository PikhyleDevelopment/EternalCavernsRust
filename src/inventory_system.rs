use super::{
    gamelog::GameLog, CombatStats, Consumable, Entity, InBackpack, InflictsDamage, Map, Name,
    Position, ProvidesHealing, WantsToDropItem, WantsToPickupItem, WantsToUseItem,
};
use crate::{AreaOfEffect, Confusion, SufferDamage};
use specs::prelude::*;
