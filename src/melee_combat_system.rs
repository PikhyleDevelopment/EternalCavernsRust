use super::{
    gamelog::GameLog, particle_system::ParticleBuilder, skill_bonus, Attributes, Wearable,
    Equipped, HungerClock, HungerState, MeleeWeapon, Name, Pools, Position, Skill, Skills,
    SufferDamage, WantsToMelee, NaturalAttackDefense
};
use specs::prelude::*;
use crate::{WeaponAttribute, EquipmentSlot};
...
impl<'a> System<'a> for MeleeCombatSystem {
    ...
    fn run(&mut self, data: Self::SystemData) {
        ...
        for (entity, wants_melee, name, attacker_attributes, attacker_skills, attacker_pool) in (
            &entities,
            &wants_melee,
            &names,
            &attributes,
            ...
            .join()
        {
            ...
            if attacker_pool.hit_points.current > 0 && target_pools.hit_points.current > 0 {
